...
export interface DotMatrixCommonProps {
   ...
   */
  bloom?: boolean;
  /** Uniform glow on every active dot (0â¦1); slightly wider falloff than selective `bloom`. */
  halo?: number;
  animated?: boolean;
...
/** Root class when `halo` > 0 â CSS widens drop-shadow falloff for a softer, more diffuse glow. */
...
/**
 * Bloom level and dot class for one cell. `curveOpacity` is the loaderâs logical opacity **before**
